...
if (isset($_GET['ID'])) {
	...
	$sql = "SELECT * FROM customer_list WHERE uuid='$ID'";
          ...
          <div class="card-body">
            <div class="col-sm-10">
              <div class="input-group mx-sm-5 mb-3">
                ...
                <input type="text" class="form-control" id="company_name" name="company_name" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?php echo $row['custsat_name'] ?>" readonly="readonly" required>
              </div>
            </div>
            <div class="col-sm-10">
              <div class="input-group mx-sm-5 mb-3">
